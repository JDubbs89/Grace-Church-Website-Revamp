        ...
        <section className="section-full">
            ...
            <div className="flex flex-row h-full overflow-x-scroll">
                {props.actions.map((action, index)=>(
                    <div key={action.title + index} className="flex flex-col justify-between min-w-[60vw] md:min-w-[25vw] min-h-0 overflow-clip bg-gradient-to-br to-[#3470bec2] from-[#044f73]">
